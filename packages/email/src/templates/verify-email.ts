...
export function buildVerifyEmail(opts: VerifyEmailOptions): { subject: string; html: string } {
  const subject = "Verify your email address — Vigilry";
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <p style="margin:0 0 24px;color:#3f3f46;font-size:15px;">Thanks for signing up. Click the button below to verify your email address. This link expires in 24 hours.</p>
      <a class="btn" href="${opts.verificationUrl}">Verify email address</a>
      <p style="margin:24px 0 0;color:#71717a;font-size:12px;">If you didn't create an account, you can safely ignore this email.</p>
    </div>
    <div class="footer">
